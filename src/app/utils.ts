...
/**
 * Center a window on its parent window instead of on the screen.
 *
 * @param window - Browser window to position
 * @param parentWindow - Window to center on, the screen is used when there is none
 */
export function centerOnParent(window: BrowserWindow, parentWindow?: BrowserWindow) {
	// Without a parent window there is nothing to center on, the screen center is used
...
const windows = ['authentication', 'callbox', 'certificate', 'help', 'lock', 'talk', 'upgrade', 'welcome'] as const
